---
name: loop
description: "Use after completing or reviewing a feature when multiple failures or changing test results require repeated assess, route, fix, and verify cycles. Use the requested scope to fix in-scope defects automatically, and request approval before fixing out-of-scope or uncertain failures. Do not use for a single localized defect; use the fix skill instead."
---
